                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white border border-slate-200 text-black placeholder-black/50 font-medium rounded-2xl focus:outline-none focus:border-[#8b6ce5]/50 focus:ring-4 focus:ring-[#8b6ce5]/10 hover:border-slate-300 transition-all duration-300 text-sm py-4 px-6"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      required
                      rows="4"
                      className="w-full bg-white border border-slate-200 text-black placeholder-black/50 font-medium rounded-2xl focus:outline-none focus:border-[#8b6ce5]/50 focus:ring-4 focus:ring-[#8b6ce5]/10 hover:border-slate-300 transition-all duration-300 text-sm resize-none py-4 px-6"
                    />
                  </div>
