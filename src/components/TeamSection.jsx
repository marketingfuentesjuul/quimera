        ...
        >
          ...
          <div className="grid grid-cols-1 grid-cols-md-2 gap-8 items-center" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ zIndex: 3 }}>
              ...
              <p className="text-muted" style={{ fontSize: '0.9375rem', marginBottom: '1.25rem', lineHeight: '1.6', color: '#4b5563' }}>
              ...
              <p className="text-muted" style={{ fontSize: '0.9375rem', marginBottom: '1.5rem', lineHeight: '1.6', color: '#4b5563' }}>
