      ...
      <div className="container">
        ...
        >
          ...
          <h2 style={{ fontSize: 'var(--font-3xl)', marginBottom: '1rem', color: '#000' }}>
            How can we help your company <span style={{ background: 'linear-gradient(180deg, transparent 40%, var(--color-accent) 40%)', padding: '0 0.3rem', borderRadius: '4px' }}>begin operations in Chile</span>?
          </h2>
